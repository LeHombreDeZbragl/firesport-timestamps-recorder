...
echo "   python3 firetimer-cutvids.py -i <input.mp4> -t <timestamps.txt> -o <output_folder>"
echo ""
...
echo "   python3 firetimer-cutvids.py -i full_stream.mp4 -t timestamps.txt -o segments"
echo ""
